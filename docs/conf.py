...
html_baseurl = 'https://donatello-py.readthedocs.io/en/latest/'
...
extlinks = {
    'issue': ('https://github.com/hampta/donatello-py/issues/%s', 'GH-%s'),
    'donatello-api': ('https://donatello.to/panel/doc-api/%s', 'Donatello API '),
}
...
resource_links = {
  'issues': 'https://github.com/hampta/donatello-py/issues',
  'discussions': 'https://github.com/hampta/donatello-py/discussions',
  'examples': f'https://github.com/hampta/donatello-py/tree/{branch}/examples',
}
...
htmlhelp_basename = 'donatello-pydoc'
...
latex_documents = [
  ('index', 'donatello-py.tex', 'donatello-py Documentation',
    'hampta', 'manual'),
]
...
man_pages = [
    ('index', 'donatello-py', 'donatello-py Documentation',
        ['hampta'], 1)
]
...
texinfo_documents = [
  ('index', 'donatello-py', 'donatello-py Documentation',
    'hampta', 'donatello-py', 'A simple asynchronous wrapper for the donatello API written in Python.',
    'Miscellaneous'),
]
